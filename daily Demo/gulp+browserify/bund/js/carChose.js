  ...
  function s(o, u) {
    ...
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      ...
      function seriesBoxOpen(res) {
        liUrl1 = $('.seriesBox .seriesBoxInfo').eq(0), liUrl2 = $('.seriesBox .list-group-item').eq(0);
      ...
      function erroCallback() {}
    }).call(this, require("XJF/FV"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/carChose.js", "/");
