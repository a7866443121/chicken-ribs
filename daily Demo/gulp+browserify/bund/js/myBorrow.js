...
(function e(t, n, r) {
  function s(o, u) {
          ...
          comom.request(resPath.getResUrl() + '/zs/customer/queryMyCustomerList/V2_0', data, function (res) {
            ...
            if (res.respData.length > 0) {
              res.respData.forEach(function (val, index) {
                ...
                oLi.innerHTML = '<div class="content">' + '<p class="f-14 f-grey">' + (val.createDateStr || '-') + '</p>' + '<p class="f-15">' + (val.name || '') + '<span class="fr">' + (val.cellphone || '-') + '</span></p>' + '<p class="f-15">意向贷款金额(元)<span class="fr">' + (val.loanPriceStr || '-') + '</span></p>' + '<p class="f-15">意向贷款期限(期)<span class="fr">' + (val.loanLimit || '-') + '</span></p>' + '</div>';
    ...
    }).call(this, require("XJF/FV"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/myBorrow.js", "/");
