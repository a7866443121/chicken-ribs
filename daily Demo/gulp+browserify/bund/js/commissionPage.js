...
(function e(t, n, r) {
  function s(o, u) {
    ...
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      ...
      function getData(res) {
        ...
        if (incomeListVos.length > 0) {
          for (var j = 0; j < incomeListVos.length; j++) {
            getListStr = '<li>' + '<div class="text-left">' + '<span class="data-getTime f-grey f-13">' + (incomeListVos[j].amountDate || ' ') + '</span>' + '<p class="mt10 f-14">推荐 <span class="data-rcommName">' + (incomeListVos[j].customer || ' ') + '</span>（<span class="data-rcommPhone">' + (incomeListVos[j].custPhone || ' ') + '</span>）</p>' + '</div>' + '<div class="text-right data-getMoney f-theme f-15">+' + (incomeListVos[j].amount || ' ') + '元</div>' + '</li>';
        ...
        if (withdrawListVos.length > 0) {
          for (var i = 0; i < withdrawListVos.length; i++) {
            ...
            cashListStr = '<li>' + '<div class="text-left">' + '<span class="data-reduceTime f-grey f-13">' + (withdrawListVos[i].amountDate || ' ') + '</span>' + '<p class="mt10 f-14">提现</p>' + '</div>' + '<div class="text-right">' + '<span class="data-reduceMoney f-15">-' + (withdrawListVos[i].amount || ' ') + '元</span>' + '<span class="tag f-theme f-13 ' + (status || ' ') + '">处理中</span>' + '</div>' + '</li>';
      ...
      function tabChange() {
        ...
        $('body').on('touchstart', '.tab-content', function (e) {
          ...
          if (touch.pageX - startX > 30 && touch.pageX - startX > touch.pageY - startY) {
            //向左
            lefTap = lefTap + 1;
            selectorPrev('.tab-content ul');
            selectorPrev('.tab li');
            $(this).off('touchmove');
          } else if (touch.pageX - startX < -30 && touch.pageX - startX < touch.pageY - startY) {
            //向右
            lefTap = lefTap - 1;
    ...
    }).call(this, require("XJF/FV"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/commissionPage.js", "/");
