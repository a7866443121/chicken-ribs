    ...
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      ...
      function submitData() {
        ...
        comom.slt('#submit_btn').addEventListener('click', function () {
          ...
          //验证参数
          if (dtValue()) {
            comom.request(resPath.path + '/zs/process_post', parameter, function (res) {
      ...
      submitData();
    }).call(this, require("XJF/FV"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/node_test.js", "/");
