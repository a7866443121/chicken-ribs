...
(function e(t, n, r) {
  function s(o, u) {
    ...
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      ...
      function validBack(res) {
        if (res.respCode == 0) {
          ...
          setTimeout(function () {
            location.href = "cusRecommend.html";
          }, 1000);
        }
      }
    ...
    }).call(this, require("XJF/FV"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/login.js", "/");
