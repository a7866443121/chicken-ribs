...
(function e(t, n, r) {
  function s(o, u) {
      ...
      window.onload = function () {
        ...
        if (openId) {
          ...
          comom.request(resPath.getResUrl() + '/zs/usr/queryUserInfo/v2_0', data, function (res) {
            ...
            comom.slt('#header').innerHTML = ' <div class="my-header"><span><img src="' + res.respData.wechatIcon + '"/></span></div>' + '<div class="my-name"><font>' + res.respData.realName + '</font></div>' + organizationNameStr;
            //tab
            comom.slt('#nav').innerHTML = '<div class="nav-left">我借过' + '<p id="borrow_money">' + (res.respData.loanAmountStr || '0.00') + '<small> 元</small></p></div>' + '<div class="nav-right">我赚了' + '<p id="make_money">' + (res.respData.brokageAmountStr || '0.00') + '<small> 元</small></p></div>';
          });
        } else {
        ...
        comom.slt('#my_list').onclick = function (evevt) {
          ...
          switch (obj.id) {
            case 'my_borrow':
              location.href = 'myBorrow.html?' + comom.forLoadHref(data);
              break;
            case 'my_recommend':
              location.href = 'myRecommend.html?' + comom.forLoadHref(data);
              break;
            case 'my_money_detail':
              location.href = 'commissionPage.html?' + comom.forLoadHref(data);
              break;
            default:
              break;
          }
    ...
    }).call(this, require("XJF/FV"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/personalCenter.js", "/");
